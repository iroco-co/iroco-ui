		...
		module.exports = shouldUseNative()
			...
			: function (target, source) {
					for (var from2, to = toObject(target), symbols, s = 1; s < arguments.length; s++) {
						...
						for (var key in from2) hasOwnProperty3.call(from2, key) && (to[key] = from2[key]);
...
var require_react_development = __commonJS({
    ...
    in`) === 0;
			...
			var ReactElement = function (type, key, ref, self2, source, owner, props) {
				var element = { $$typeof: REACT_ELEMENT_TYPE, type, key, ref, props, _owner: owner };
				return (
					(element._store = {}),
			...
			function createElement2(type, config, children) {
				var propName,
					...
					source = null;
				if (config != null) {
					hasValidRef(config) && ((ref = config.ref), warnIfStringRefCannotBeAutoConverted(config)),
			...
			function getComponentKey(component, index) {
				return typeof component == 'object' && component !== null && component.key != null
			...
			function mapIntoWithKeyPrefixInternal(children, array, prefix2, func, context) {
				var escapedPrefix = '';
				prefix2 != null && (escapedPrefix = escapeUserProvidedKey(prefix2) + '/');
			...
			function lazy(ctor) {
				var lazyType = { $$typeof: REACT_LAZY_TYPE, _ctor: ctor, _status: -1, _result: null };
				{
...
Check the top-level render call using <` +
			...
			function validateChildKeys(node2, parentType) {
				if (typeof node2 == 'object') {
					...
					else if (isValidElement(node2)) node2._store && (node2._store.validated = !0);
					else if (node2) {
	...
	'../../node_modules/scheduler/cjs/scheduler.development.js'(exports) {
		...
		(function () {
				...
				for (var index = i, length2 = heap.length; index < length2; ) {
					...
					if (left !== void 0 && compare(left, node2) < 0)
						right !== void 0 && compare(right, left) < 0
							? ((heap[index] = right), (heap[rightIndex] = node2), (index = rightIndex))
							: ((heap[index] = left), (heap[leftIndex] = node2), (index = leftIndex));
			...
			var NoPriority = 0,
				...
				sharedProfilingBuffer =
					typeof SharedArrayBuffer == 'function'
						...
						: null,
				profilingState =
					sharedProfilingBuffer !== null ? new Int32Array(sharedProfilingBuffer) : [],
				PRIORITY = 0,
				CURRENT_TASK_ID = 1,
				CURRENT_RUN_ID = 2,
				QUEUE_SIZE = 3;
			...
			function markSchedulerSuspended(ms) {
				mainThreadIdCounter++,
					eventLog !== null && logEvent([SchedulerSuspendEvent, ms * 1e3, mainThreadIdCounter]);
			}
	...
	'../../node_modules/react-dom/cjs/react-dom.development.js'(exports) {
		...
		(function () {
			...
			var React3 = require_react(),
				...
				ReactSharedInternals = React3.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
			...
			function getValueForAttribute(node2, name, expected) {
				{
					...
					if (!node2.hasAttribute(name)) return expected === void 0 ? void 0 : null;
  ...
  const MyComponent = lazy(() => import('./MyComponent'))`,
			...
			function trackValueOnNode(node2) {
				...
				if (
					...
					Object.defineProperty(node2, valueField, {
						...
						Object.defineProperty(node2, valueField, { enumerable: descriptor.enumerable });
					var tracker = {
						getValue: function () {
							return currentValue;
						},
			...
			function updateWrapper(element, props) {
				...
				if (value != null)
					type === 'number'
						...
						: node2.value !== toString(value) && (node2.value = toString(value));
			...
			function postMountWrapper(element, props, isHydrating2) {
				...
				if (props.hasOwnProperty('value') || props.hasOwnProperty('defaultValue')) {
					...
					isHydrating2 || (initialValue !== node2.value && (node2.value = initialValue)),
			...
			function setDefaultValue(node2, type, value) {
				(type !== 'number' || node2.ownerDocument.activeElement !== node2) &&
					(value == null
						...
						: node2.defaultValue !== toString(value) && (node2.defaultValue = toString(value)));
			}
...
Check the render method of \`` +
			...
			function postUpdateWrapper(element, props) {
				...
				value != null
					...
					: wasMultiple !== !!props.multiple &&
					  (props.defaultValue != null
							? updateOptions(node2, !!props.multiple, props.defaultValue, !0)
							: updateOptions(node2, !!props.multiple, props.multiple ? [] : '', !1));
			}
			...
			var createMicrosoftUnsafeLocalFunction = function (func) {
				...
				setInnerHTML = createMicrosoftUnsafeLocalFunction(function (node2, html) {
					if (node2.namespaceURI === Namespaces.svg && !('innerHTML' in node2)) {
			...
			function getListenerMapForElement(element) {
				...
				return (
					listenerMap === void 0 &&
						((listenerMap = new Map()), elementListenerMap.set(element, listenerMap)),
					listenerMap
				);
			}
			function get(key) {
			...
			function findCurrentHostFiber(parent) {
				...
				for (var node2 = currentParent; ; ) {
					if (node2.tag === HostComponent || node2.tag === HostText) return node2;
					if (node2.child) {
					...
					for (var styleName in styles)
						if (styles.hasOwnProperty(styleName)) {
							...
							if (styleValue != null) {
								...
								(serialized +=
									delimiter2 +
									(isCustomProperty2 ? styleName : hyphenateStyleName(styleName)) +
									':'),
			...
			function setValueForStyles(node2, styles) {
				...
				for (var styleName in styles)
					if (styles.hasOwnProperty(styleName)) {
						...
						var styleValue = dangerousStyleValue(styleName, styles[styleName], isCustomProperty2);
...
`
				...
				outer: for (;;) {
					for (
						...
						node2 === anchorNode &&
							...
							node2.nodeType === TEXT_NODE && (length2 += node2.nodeValue.length),
					...
					for (;;) {
						...
						if (
							(parentNode === anchorNode &&
								...
								(start = length2),
							parentNode === focusNode && ++indexWithinFocus === focusOffset && (end = length2),
			...
			function setOffsets(node2, offsets) {
				...
				if (win.getSelection) {
					var selection = win.getSelection(),
						...
						end = offsets.end === void 0 ? start : Math.min(offsets.end, length2);
			...
			function isInDocument(node2) {
				return (
					node2 && node2.ownerDocument && containsNode(node2.ownerDocument.documentElement, node2)
				);
			}
			...
			function unhideInstance(instance, props) {
				...
				var styleProp = props[STYLE$1],
					display =
						styleProp != null && styleProp.hasOwnProperty('display') ? styleProp.display : null;
			...
			function traverseEnterLeave(from2, to, fn, argFrom, argTo) {
				for (
					var common = from2 && to ? getLowestCommonAncestor(from2, to) : null, pathFrom = [];
					!(!from2 || from2 === common);
					...
					extractEvents: function (
						...
						if (isOutEvent) {
							...
							if (((to = related ? getClosestInstanceFromNode(related) : null), to !== null)) {
								...
								(to !== nearestMounted || (to.tag !== HostComponent && to.tag !== HostText)) &&
									(to = null);
							}
			...
			};
			{
				var findStrictRoot = function (fiber) {
						for (var maybeStrictRoot = null, node2 = fiber; node2 !== null; )
							node2.mode & StrictMode && (maybeStrictRoot = node2), (node2 = node2.return);
					...
					if (family === void 0) {
						if (type != null && typeof type.render == 'function') {
							...
							if (type.render !== currentRender) {
								...
								return (
									type.displayName !== void 0 && (syntheticType.displayName = type.displayName),
									syntheticType
								);
							}
						}
			...
			function isCompatibleFamilyForHotReloading(fiber, element) {
				{
					...
					switch (fiber.tag) {
						...
						case FunctionComponent: {
							(typeof nextType == 'function' || $$typeofNextType === REACT_LAZY_TYPE) &&
						...
						family !== void 0 &&
							(staleFamilies.has(family)
								...
								: updatedFamilies.has(family) &&
								  (tag === ClassComponent ? (needsRemount = !0) : (needsRender = !0)));
					}
					failedBoundaries !== null &&
			...
			function findHostInstancesForFiberShallowly(fiber, hostInstances) {
				{
					...
					for (var node2 = fiber; ; ) {
						...
						if (node2.return === null) throw new Error('Expected to reach root first.');
						node2 = node2.return;
					}
				}
			}
			function findChildHostInstancesForFiberShallowly(fiber, hostInstances) {
				for (var node2 = fiber, foundHostInstances = !1; ; ) {
					...
					for (; node2.sibling === null; ) {
						if (node2.return === null || node2.return === fiber) return foundHostInstances;
						node2 = node2.return;
					}
					(node2.sibling.return = node2.return), (node2 = node2.sibling);
				}
...
https://fb.me/react-unsafe-component-lifecycles`,
  ...
  ` + foundWillUpdateName
				...
				return (
					isLegacyContextConsumer && cacheContext(workInProgress2, unmaskedContext, context),
					instance
				);
			}
				...
				function updateSlot(returnFiber, oldFiber, newChild, expirationTime) {
					...
					if (typeof newChild == 'object' && newChild !== null) {
						...
						if (isArray$1(newChild) || getIteratorFn(newChild))
							return key !== null
								? null
								: updateFragment2(returnFiber, oldFiber, newChild, expirationTime, null);
						throwOnInvalidObjectType(returnFiber, newChild);
					}
					return typeof newChild == 'function' && warnOnFunctionType(), null;
				}
...
Incoming: %s`,
			...
			function resetHooksAfterThrow() {
				if (
					((ReactCurrentDispatcher.current = ContextOnlyDispatcher), didScheduleRenderPhaseUpdate)
				)
			...
			function mountEffectImpl(fiberEffectTag, hookEffectTag, create3, deps) {
				...
				(currentlyRenderingFiber$1.effectTag |= fiberEffectTag),
					(hook.memoizedState = pushEffect(HasEffect | hookEffectTag, create3, void 0, nextDeps));
			}
			function updateEffectImpl(fiberEffectTag, hookEffectTag, create3, deps) {
				...
				(currentlyRenderingFiber$1.effectTag |= fiberEffectTag),
					(hook.memoizedState = pushEffect(HasEffect | hookEffectTag, create3, destroy, nextDeps));
			}
			...
			function mountTransition(config) {
				var _mountState2 = mountState(!1),
					...
					start = mountCallback(startTransition.bind(null, setPending, config), [
						setPending,
						config
					]);
			...
			function updateTransition(config) {
				var _updateState2 = updateState(),
					...
					start = updateCallback(startTransition.bind(null, setPending, config), [
						setPending,
						config
					]);
				return [start, isPending];
				...
				InvalidNestedHooksDispatcherOnRerenderInDEV = null;
			{
				...
				(HooksDispatcherOnMountInDEV = {
					...
					useTransition: function (config) {
						return (
							(currentHookNameInDev = 'useTransition'), mountHookTypesDev(), mountTransition(config)
						);
					}
				}),
					(HooksDispatcherOnMountWithHookTypesInDEV = {
						...
						useRef: function (initialValue) {
							return (
								(currentHookNameInDev = 'useRef'), updateHookTypesDev(), mountRef(initialValue)
							);
						},
						useState: function (initialState) {
					...
					(HooksDispatcherOnUpdateInDEV = {
						...
						useDebugValue: function (value, formatterFn) {
							return (
								(currentHookNameInDev = 'useDebugValue'), updateHookTypesDev(), updateDebugValue()
							);
						},
						useResponder: function (responder, props) {
							return (
			...
			function updateHostRoot(current2, workInProgress2, renderExpirationTime2) {
				...
				if (root2.hydrate && enterHydrationState(workInProgress2)) {
					...
					for (var node2 = child; node2; )
						(node2.effectTag = (node2.effectTag & ~Placement) | Hydrating), (node2 = node2.sibling);
				} else
					reconcileChildren(current2, workInProgress2, nextChildren, renderExpirationTime2),
						resetHydrationState();
...
Check the render method of \`` +
				...
				if (
						...
						if (
							...
							var progressedState = workInProgress2.memoizedState,
								progressedPrimaryChild =
									progressedState !== null ? workInProgress2.child.child : workInProgress2.child;
					...
					if (prevState !== null) {
						...
						if (nextDidTimeout) {
							...
							if (workInProgress2.mode & ProfileMode) {
								for (
									var _treeBaseDuration2 = 0, _hiddenChild2 = _primaryChildFragment3.child;
									_hiddenChild2 !== null;
			...
			function propagateSuspenseContextChange(workInProgress2, firstChild, renderExpirationTime2) {
				for (var node2 = firstChild; node2 !== null; ) {
					...
					for (; node2.sibling === null; ) {
						if (node2.return === null || node2.return === workInProgress2) return;
						node2 = node2.return;
					}
					(node2.sibling.return = node2.return), (node2 = node2.sibling);
				}
			...
			function findLastContentRow(firstChild) {
				for (var row = firstChild, lastContentRow = null; row !== null; ) {
					...
					currentRow !== null && findFirstSuspended(currentRow) === null && (lastContentRow = row),
						(row = row.sibling);
				}
			...
			function completeWork(current2, workInProgress2, renderExpirationTime2) {
				...
				switch (workInProgress2.tag) {
					...
					case SuspenseComponent: {
						...
						return (
							(nextDidTimeout || prevDidTimeout) && (workInProgress2.effectTag |= Update), null
						);
					}
					case HostPortal:
						...
						if (renderedTail === null)
							...
							if (!didSuspendAlready) {
								...
								if (_suspended !== null) {
									...
									(workInProgress2.expirationTime = workInProgress2.childExpirationTime =
										nextPriority),
...
Learn more about data fetching with Hooks: https://fb.me/react-hooks-data-fetching`)
			...
			function hideOrUnhideAllChildren(finishedWork, isHidden) {
				for (var node2 = finishedWork; ; ) {
					if (node2.tag === HostComponent) {
						...
						(fallbackChildFragment.return = node2), (node2 = fallbackChildFragment);
						continue;
					} else if (node2.child !== null) {
						(node2.child.return = node2), (node2 = node2.child);
						continue;
			...
			function commitDetachRef(current2) {
				...
				currentRef !== null &&
					(typeof currentRef == 'function' ? currentRef(null) : (currentRef.current = null));
			}
								...
								var firstEffect = lastEffect.next;
								{
									...
									runWithPriority$1(priorityLevel, function () {
										...
										do {
											...
											_destroy !== void 0 && safelyCallDestroy(current2, _destroy),
												(effect = effect.next);
										} while (effect !== firstEffect);
									});
								}
			...
			function getHostSibling(fiber) {
				...
				siblings: for (;;) {
					for (; node2.sibling === null; ) {
						if (node2.return === null || isHostParent(node2.return)) return null;
						node2 = node2.return;
					}
					for (
						node2.sibling.return = node2.return, node2 = node2.sibling;
						...
						if (node2.effectTag & Placement || node2.child === null || node2.tag === HostPortal)
							continue siblings;
						(node2.child.return = node2), (node2 = node2.child);
					}
			...
			function unmountHostComponents(finishedRoot, current2, renderPriorityLevel) {
				for (
					var node2 = current2, currentParentIsValid = !1, currentParent, currentParentIsContainer;
					;
					...
					if (node2.tag === HostComponent || node2.tag === HostText)
						...
						(commitUnmount(finishedRoot, node2, renderPriorityLevel), node2.child !== null)
					) {
						(node2.child.return = node2), (node2 = node2.child);
						continue;
					}
					...
					for (; node2.sibling === null; ) {
						...
						(node2 = node2.return), node2.tag === HostPortal && (currentParentIsValid = !1);
					}
					(node2.sibling.return = node2.return), (node2 = node2.sibling);
				}
			}
...
Add a <Suspense fallback=...> component higher in the tree to provide a loading indicator or placeholder to display.` +
			...
			function requestCurrentTimeForUpdate() {
				return (executionContext & (RenderContext | CommitContext)) !== NoContext
					...
					: (currentEventTime !== NoWork || (currentEventTime = msToExpirationTime(now())),
					  currentEventTime);
			}
			...
			function getNextRootExpirationTimeToWorkOn(root2) {
				...
				var lastPingedTime = root2.lastPingedTime,
					...
					nextLevel =
						lastPingedTime > nextKnownPendingLevel ? lastPingedTime : nextKnownPendingLevel;
				...
				do {
					...
					if ((workInProgress.effectTag & Incomplete) === NoEffect) {
						...
						if ((workInProgress.mode & ProfileMode) !== NoMode) {
							stopProfilerTimerIfRunningAndRecordDelta(workInProgress, !1);
							for (
								var actualDuration = workInProgress.actualDuration, child = workInProgress.child;
								child !== null;
						...
						if (_next !== null)
							return (
								stopFailedWorkTimer(workInProgress), (_next.effectTag &= HostEffectMask), _next
							);
						stopWorkTimer(workInProgress),
							returnFiber !== null &&
			...
			function commitRootImpl(root2, renderPriorityLevel) {
				...
				if (
					...
					do
						if (
							(invokeGuardedCallback(null, commitBeforeMutationEffects, null), hasCaughtError())
						) {
				...
				return (
					(executionContext & LegacyUnbatchedContext) !== NoContext || flushSyncCallbackQueue(),
					null
				);
			}
				...
				for (var fiber = sourceFiber.return; fiber !== null; ) {
					if (fiber.tag === HostRoot) {
						...
						if (
							...
							root2 !== null &&
								(ensureRootIsScheduled(root2), schedulePendingInteractions(root2, Sync));
							return;
						}
					}
					fiber = fiber.return;
			...
			function retryTimedOutBoundary(boundaryFiber, retryTime) {
				...
				root2 !== null &&
					(ensureRootIsScheduled(root2), schedulePendingInteractions(root2, retryTime));
			}
...
Check the render method of \`` +
			...
			function updateContainer(element, container, parentComponent, callback) {
				...
				var current$1 = container.current,
					currentTime = requestCurrentTimeForUpdate();
				typeof jest < 'u' &&
					(warnIfUnmockedScheduler(current$1), warnIfNotScopedWithMatchingAct(current$1));
			...
			function isValidContainer(node2) {
				return !!(
					...
					(node2.nodeType === ELEMENT_NODE ||
						...
						(node2.nodeType === COMMENT_NODE && node2.nodeValue === ' react-mount-point-unstable '))
				);
			}
...
function commenter(type, index) {
	for (
		;
		next() && type + character !== 47 + 10 && !(type + character === 42 + 42 && peek() === 47);
		...
		switch (((previous = character2), (character2 = next()))) {
			case 40:
				if (previous != 108 && charat(characters2, length2 - 1) == 58) {
					indexof((characters2 += replace(delimit(character2), '&', '&\f')), '&\f') != -1 &&
						(ampersand = -1);
					break;
				}
			case 34:
	...
	serializeStyles = function (args, registered, mergedProps) {
		...
		for (var i = 1; i < args.length; i++)
			(styles += handleInterpolation(mergedProps, registered, args[i])),
				stringMode &&
					(strings[i] === void 0 && console.error(ILLEGAL_ESCAPE_SEQUENCE_ERROR),
					(styles += strings[i]));
		var sourceMap;
...
var useTheme = function () {
	...
	ThemeProvider = function (props) {
		...
		return (
			...
			React2.createElement(ThemeContext.Provider, { value: theme3 }, props.children)
		);
	};
function withTheme(Component) {
	var componentName = Component.displayName || Component.name || 'Component',
		render = function (props, ref) {
			var theme3 = React2.useContext(ThemeContext);
			return React2.createElement(Component, _extends22({ theme: theme3, ref }, props));
		},
...
var pkg = {
	...
	Global = withEmotionCache(function (props, cache) {
		...
		var styles = props.styles,
			serialized = serializeStyles([styles], void 0, React2.useContext(ThemeContext)),
		...
		return (
			useInsertionEffectWithLayoutFallback(
				function () {
					...
					return (
						...
						node2 !== null &&
							((rehydrating = !0), node2.setAttribute('data-emotion', key), sheet.hydrate([node2])),
			...
			useInsertionEffectWithLayoutFallback(
				function () {
					...
					if (
						(serialized.next !== void 0 && insertStyles(cache, serialized.next, !0),
						sheet.tags.length)
					) {
...
(isBrowser3 = !0),
	...
	isBrowser3 &&
		!isTestEnv &&
		((globalContext = typeof globalThis < 'u' ? globalThis : isBrowser3 ? window : global),
		...
		return function () {
			...
			if (
				...
				for (var len = args.length, i = 1; i < len; i++)
					args[0][i] === void 0 && console.error(ILLEGAL_ESCAPE_SEQUENCE_ERROR2),
...
var createReset = (0, import_memoizerific.default)(1)(({ typography: typography2 }) => ({
		body: {
		...
		return matches
			? arr.concat(
					matches.map(function (match2) {
						var _a, _b;
						return (_b =
							(_a = match2.match(/[\t ]/g)) === null || _a === void 0 ? void 0 : _a.length) !==
							null && _b !== void 0
							? _b
							: 0;
					})
