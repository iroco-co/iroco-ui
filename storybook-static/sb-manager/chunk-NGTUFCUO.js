...
function distanceAndSkiddingToXY(placement, rects, offset2) {
	var basePlacement = getBasePlacement(placement),
		...
		_ref =
			typeof offset2 == 'function' ? offset2(Object.assign({}, rects, { placement })) : offset2,
		skidding = _ref[0],
		distance = _ref[1];
	return (
		(skidding = skidding || 0),
...
function usePopperTooltip(config, popperOptions) {
	...
	React3.useEffect(
		...
		React3.useEffect(
			function () {
				if (
					!(tooltipRef == null || !isTriggeredBy('hover') || !getLatest().finalConfig.interactive)
				)
					return (
	...
	React3.useEffect(
		...
		React3.useEffect(
			function () {
				if (
					!(tooltipRef == null || update == null || finalConfig.mutationObserverOptions == null)
				) {
