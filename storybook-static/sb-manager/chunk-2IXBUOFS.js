import { logger, newStyled, require_react, require_react_dom, scope } from './chunk-INSKDKQB.js';
import {
		...
		'../../node_modules/refractor/core.js'(exports, module) {
			...
			function stringifyAll(values, language) {
				for (var result = [], length = values.length, index = -1, value; ++index < length; )
					(value = values[index]),
						value !== '' && value !== null && value !== void 0 && result.push(value);
...
function flattenCodeTree(tree) {
	for (
		...
		if (node.type === 'text')
			newTree.push(
				createLineElement({ children: [node], className: _toConsumableArray(new Set(className)) })
			);
...
`
					...
					if (i === 0) {
						...
						var stringChild =
								tree[index + 1] && tree[index + 1].children && tree[index + 1].children[0],
...
var $8927f6f2acc4f386$var$NODES = [
	...
	$8927f6f2acc4f386$export$250ffa63cdc0d034 = $8927f6f2acc4f386$var$NODES.reduce(
		(primitive, node) => {
		...
		$9f79659886946c16$export$e5c5a5f917a5871c(() => {
			...
			if (wasPresent !== present) {
				...
				present
					...
					? send('UNMOUNT')
					: send(
							wasPresent && prevAnimationName !== currentAnimationName ? 'ANIMATION_OUT' : 'UNMOUNT'
					  ),
...
var $57acba87d6e25586$var$SCROLL_AREA_NAME = 'ScrollArea',
	...
	$57acba87d6e25586$export$ccf8d8d7bbf3c2cc = (0, import_react.forwardRef)(
		(props, forwardedRef) => {
			let {
				...
				[scrollbarXEnabled, setScrollbarXEnabled] = (0, import_react.useState)(!1),
				[scrollbarYEnabled, setScrollbarYEnabled] = (0, import_react.useState)(!1),
				composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, (node) =>
					setScrollArea(node)
				),
		...
		(props, forwardedRef) => {
			...
			return (
				...
				(0, import_react.createElement)(
					...
					(0, import_react.createElement)(
						$57acba87d6e25586$var$ScrollAreaScrollbarAuto,
						_extends2({ 'data-state': visible ? 'visible' : 'hidden' }, scrollbarProps, {
							ref: forwardedRef
						})
					)
				)
	...
	$57acba87d6e25586$var$ScrollAreaScrollbarScroll = (0, import_react.forwardRef)(
		(props, forwardedRef) => {
			let { forceMount, ...scrollbarProps } = props,
				context = $57acba87d6e25586$var$useScrollAreaContext(
					$57acba87d6e25586$var$SCROLLBAR_NAME,
			...
			return (
				...
				(0, import_react.createElement)(
					...
					(0, import_react.createElement)(
						$57acba87d6e25586$var$ScrollAreaScrollbarVisible,
						_extends2({ 'data-state': state === 'hidden' ? 'hidden' : 'visible' }, scrollbarProps, {
							ref: forwardedRef,
	...
	$57acba87d6e25586$var$ScrollAreaScrollbarVisible = (0, import_react.forwardRef)(
		(props, forwardedRef) => {
	...
	$57acba87d6e25586$var$ScrollAreaScrollbarImpl = (0, import_react.forwardRef)(
		(props, forwardedRef) => {
			let {
				...
				composeRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, (node) =>
					setScrollbar(node)
				),
				...
				handleThumbPositionChange =
					$b1b2314f5f9a1d84$export$25bec8c6f54ee79a(onThumbPositionChange),
...
function $57acba87d6e25586$var$useDebounceCallback(callback, delay) {
	...
	return (
		(0, import_react.useEffect)(() => () => window.clearTimeout(debounceTimerRef.current), []),
...
var $57acba87d6e25586$export$be92b6f5f03c0fe9 = $57acba87d6e25586$export$ccf8d8d7bbf3c2cc,
	...
	ScrollArea = ({
		...
		import_react.default.createElement(
			...
			horizontal &&
				vertical &&
				import_react.default.createElement($57acba87d6e25586$export$ac61190d9fc311a9, null)
		),
...
var Wrapper = newStyled.div(
	...
	Scroller = newStyled(UnstyledScroller)({ position: 'relative' }, ({ theme }) =>
		themedSyntax(theme)
	),
	...
	SyntaxHighlighter2 = ({
		...
		let highlightableCode = formatter ? formatter(format, children) : children.trim(),
