try {
	(() => {
		...
		var G = ({ active: o, title: t, icon: e, description: r, onClick: a }) =>
			...
			j = ({
				...
				let n = a && l.createElement(k, { style: { opacity: 1 }, icon: a }),
					s = { id: r ?? '_reset', active: i === r, right: t, title: e, left: o, onClick: S };
			...
			q = $(
				({
					...
					name: t,
					description: e,
					toolbar: { icon: r, items: a, title: d, preventDynamicIcon: S, dynamicTitle: i }
				}) => {
					let [n, s] = h(),
						[I, O] = R(!1),
						u = n[o],
					...
					return l.createElement(
						...
						l.createElement(G, { active: I || p, description: e || '', icon: c, title: m || '' })
					);
				}
			),
			Z = { type: 'item', value: '' },
		...
		g.register(b, () =>
			g.add(b, { title: b, type: B.TOOL, match: () => !0, render: () => l.createElement(Q, null) })
		);
	})();
} catch (e) {
