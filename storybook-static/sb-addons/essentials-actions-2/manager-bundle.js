try {
	(() => {
		...
		function L(e, t) {
			...
			if (e && t && (r = e.constructor) === t.constructor) {
				...
				if (r === Set) {
					...
					for (n of e)
						if (((a = n), (a && typeof a == 'object' && ((a = ze(t, a)), !a)) || !t.has(a)))
							return !1;
					return !0;
				}
				if (r === Map) {
					...
					for (n of e)
						if (
							((a = n[0]),
							(a && typeof a == 'object' && ((a = ze(t, a)), !a)) || !L(n[1], t.get(a)))
						)
							return !1;
					return !0;
				}
				...
				if (!r || typeof e == 'object') {
					n = 0;
					for (r in e)
						if ((Fe.call(e, r) && ++n && !Fe.call(t, r)) || !(r in t) || !L(e[r], t[r])) return !1;
		...
		function Ut(e, t) {
			...
			var r = D(t),
				n = typeof r.alpha == 'number' ? r.alpha : 1,
				a = O({}, r, { alpha: M(0, 1, +(n * 100 - parseFloat(e) * 100).toFixed(2) / 100) });
			return Y(a);
		}
		var ks = _(Ut);
			...
			Yt = (e, t, r, n) => {
				if ((t && typeof t == 'object') || typeof t == 'function')
					for (let a of Ze(t))
						!Vt.call(e, a) &&
							a !== r &&
							ge(e, a, { get: () => t[a], enumerable: !(n = Gt(t, a)) || n.enumerable });
				return e;
			},
			Jt = (e, t, r) => (
				(r = e != null ? kt(Wt(e)) : {}),
				Yt(t || !e || !e.__esModule ? ge(r, 'default', { value: e, enumerable: !0 }) : r, e)
			),
			qt = be({
		...
		var de = ({ data: e }) => {
				...
				if (Array.isArray(r)) {
					let n = t.arrayMaxProperties,
						a = r.slice(0, n).map((s, l) => o.createElement(U, { key: l, object: s }));
		...
		var fr = ({ rows: e, columns: t, rowsData: r }) => {
			...
			br = ({ data: e, columns: t }) => {
				let r = A('TableInspector'),
					[{ sorted: n, sortIndexColumn: a, sortColumn: i, sortAscending: s }, l] = W({
						sorted: !1,
						sortIndexColumn: !1,
						sortColumn: void 0,
						sortAscending: !1
