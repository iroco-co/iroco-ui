import{p as C,f as h,a as v,b as w,t as I,s as o,c as E,g as F,h as y,j as b,k as P,l as A,e as L,m as _}from"./props-rZpV7w-1.js";import{T as x,c as H,s as B,d as D}from"./create-runtime-stories-CIwcQWO4.js";import"./index-Cu4lwwaE.js";import"./index-7SSfYZ8z.js";const S=(t,r)=>{let p=()=>L(r==null?void 0:r(),[]);var a=M(),s=h(a),l=_(s);x(l,E(p,{oninput:k}));var m=o(s,2),u=_(m);F(()=>y(u,`On input handled : ${b(g)??""}`)),v(t,a)},j={title:"Iroco-UI/Form/TextInput",component:x,argTypes:{type:{control:{type:"select"}},autocomplete:{control:{type:"select"}}}},{Story:e}=D();let g=P("");function k(t){A(g,""+t.data+" "+t.timeStamp)}var M=I('<form class="iroco-ui-form"><!></form> <p> </p>',1),R=I("<!> <!> <!> <!> <!> <!> <!> <!> <!> <!>",1);function O(t,r){C(r,!0),B(S);var p=R(),a=h(p);e(a,{name:"Default",parameters:{__svelteCsf:{rawCode:`<form class="iroco-ui-form">
